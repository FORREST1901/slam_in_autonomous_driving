...
int main(int argc, char** argv) {
    ...
    std::system("rm -rf /home/wlxing/Codes/slam_in_autonomous_driving/data/ch6/*");
    ...
    cv::imwrite("/home/wlxing/Codes/slam_in_autonomous_driving/data/ch6/global_map.png", mapping.ShowGlobalMap(2000));
    return 0;
}